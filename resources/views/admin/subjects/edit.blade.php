                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="SoTC" value="{{ $subject->SoTC }}"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="HocKy" value="{{ $subject->HocKy }}"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="SoTienMotTin"
                                value="{{ $subject->SoTienMotTin }}" placeholder="Nhập số tiền một tín" required>
                        </div>
                    </div>
                </div>
            </div>
